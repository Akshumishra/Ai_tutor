        ...
        <Card className="py-8 px-4 sm:px-10">
            ...
            <>
              ...
              {step === 1 && (
                <form className="space-y-4" onSubmit={handleVerifyOTP}>
                   ...
                   <Input label="OTP Code" id="otp" type="text" placeholder="123456" maxLength={6} value={formData.otp} onChange={handleChange} required />
                   <Button type="submit" variant="primary" className="w-full" disabled={loading}>
              ...
              {step === 2 && (
                <form className="space-y-4" onSubmit={handleRegister}>
                   <Input label="Set Password" id="password" type="password" placeholder="••••••••" value={formData.password} onChange={handleChange} required />
          ...
          {isLogin && (
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Button type="button" variant="outline" className="w-full flex justify-center items-center">
                  <GoogleIcon />
                  Google
                </Button>
              </div>
